    ...
    <div class="flex h-16 items-center justify-between gap-2 border-b border-slate-200 px-4 sm:h-[68px] sm:px-5">
        <div class="flex min-w-0 flex-1 items-center gap-2.5">
            <div class="flex h-10 shrink-0 items-center gap-2 rounded-xl border border-slate-200 bg-white px-2.5 shadow-sm shadow-slate-950/5 sm:h-12 sm:gap-2 sm:px-2.5">
                <img src="{{ asset('images/logo-bps.svg') }}" alt="Logo BPS" class="h-7 w-7 object-contain sm:h-8 sm:w-8">
                <span class="h-6 w-px bg-slate-200 sm:h-7"></span>
                <img src="{{ asset('images/logo-se2026-ribbon-only-v3.png') }}" alt="Logo SE2026" class="h-8 w-9 object-contain sm:h-9 sm:w-10">
            </div>
            <div class="min-w-0 flex-1">
                <p class="truncate text-sm font-semibold leading-tight tracking-tight text-se-ink sm:text-base">{{ config('app.name', 'Asisten SE2026') }}</p>
                <p class="mt-1 hidden text-[11px] font-semibold leading-tight text-se-rust min-[360px]:block sm:text-xs">Sensus Ekonomi 2026</p>
            </div>
        </div>
