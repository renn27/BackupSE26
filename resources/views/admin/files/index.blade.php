...
<div class="space-y-6" x-data="{ viewMode: '{{ request('type') === 'photo' ? 'grid' : 'table' }}' }">
    <div class="file-toolbar">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center justify-between">
            ...
            <a href="{{ route('admin.files.export') }}" class="w-full sm:w-auto h-[46px] flex items-center justify-center gap-1.5 rounded-2xl bg-se-primary px-4 py-3 text-xs sm:text-sm font-semibold text-white shadow-sm shadow-se-primary/20 hover:bg-se-rust transition active:scale-[0.99] focus:outline-none focus:ring-4 focus:ring-orange-100 whitespace-nowrap">
