...
@section('content')
@php($notebookUrl = 'https://notebooklm.google.com/notebook/1c715acd-c98d-4e47-9414-3ab09e96fe67')

<div class="mx-auto max-w-3xl space-y-5">
    <div class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-950/5">
        <div class="flex items-start gap-4">
            <span class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-se-subtle text-se-rust ring-1 ring-amber-200/70">
            ...
            <div class="min-w-0">
                <h1 class="text-2xl font-semibold tracking-tight text-se-ink">Tanya KonDef</h1>
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-950/5">
        <div class="rounded-3xl border border-amber-200 bg-se-subtle p-5 sm:p-6">
            <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    <span class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-se-primary text-white shadow-sm shadow-se-primary/25">
                        <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-4-.84L3 20l1.33-3.1A7.45 7.45 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                        </svg>
                    </span>
                    <div>
                        <h2 class="text-xl font-semibold tracking-tight text-se-rust">Notebook Tanya KonDef</h2>
